...
export default function FacebookPagesPage() {
  ...
  return (
    <PageShell title="Facebook Pages" description="Connect a real Facebook Page to drive automations." actions={<div className="flex flex-wrap gap-3"><ConnectFacebookButton disabled={!realModeEnabled} /></div>}>
